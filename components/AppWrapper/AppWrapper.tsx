...
export default function AppWrapper ({ children, contentWrapperStyles, isCustomBuild }: { children: ReactNode, isCustomBuild?: boolean; contentWrapperStyles?: CSSProperties }) {
